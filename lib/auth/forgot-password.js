...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (isEmail) {
      ...
      // It's a phone number. We simulate sending an SMS for now since it costs money.
      console.log(`[SIMULATED SMS to ${email}]: Your Nazia Studio OTP is ${otp}. Expires in 10 mins.`);
    }
